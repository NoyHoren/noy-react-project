...
import { showSuccessDialog } from "../ui/dialogs";
  ...
  return (
    <div className="sandBox flex flex-col justify-center items-center p-7 rounded-md text-center bg-gray-400 m-0.1 dark:bg-slate-700 relative drop-shadow-md">
      <Stack direction="column" spacing={8}>
        {usersApi.map((u) => (
          <div className="flex flex-col justify-center items-center p-7 rounded-md text-center bg-stone-200 m-2 dark:bg-slate-500 relative drop-shadow-md" key={u._id}>
