        ...
        <div className="flex flex-col justify-center items-center gap-5 mt-2 ">
            {card && (
                <div className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-stone-200 m-2  dark:bg-slate-500 dark:text-white drop-shadow-md card-style">
                    ...
                    />
                    <div className="mt-1 card-content">
                        ...
                        <p >
                            {card.web && (
                                <a href={card.web} target="_blank" rel="noopener noreferrer" style={{ color: "blue", textDecoration: "underline" }}>
                                    {card.web}
                                </a>
                            )}
                        </p>
                        <Link to={`/cardEdit/${id}`} className="flex flex-col items-center ">
                            <MdOutlineEdit className="edit-btn" />
                        </Link>
                    </div>
                </div>
            )}
            <div className=" flex flex-wrap justify-center ">
                ...
                <div className="text-sm text-center w-80 bg-stone-200 m-2 dark:bg-slate-500 p-5 rounded-md drop-shadow-md  dark:text-white "><h3 style={{ color: "hotpink" }} className="text-l px-1 py-0.5 font-bold">Description : </h3> {card?.description}</div>
            </div>
        </div>
    );
};
